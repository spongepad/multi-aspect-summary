...
def create_vocab(domain, maxlen=0, vocab_size=0):
    ...
    source = '/content/drive/MyDrive/Attention-Based-Aspect-Extraction-master/preprocessed_data/' + domain + '/train.txt'
    ...
    vocab_file = codecs.open('/content/drive/MyDrive/Attention-Based-Aspect-Extraction-master/preprocessed_data/%s/vocab' % domain, mode='w', encoding='utf8')
...
def read_dataset(domain, phase, vocab, maxlen):
    ...
    source = '/content/drive/MyDrive/Attention-Based-Aspect-Extraction-master/preprocessed_data/' + domain + '/' + phase + '.txt'
